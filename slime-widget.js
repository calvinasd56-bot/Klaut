...
(function () {
  ...
  var css = ''
    ...
    + '.klaut-slime-say{position:fixed;right:22px;bottom:118px;z-index:9997;max-width:200px;background:rgba(11,15,26,.92);border:1px solid rgba(255,255,255,.08);border-radius:8px;padding:7px 10px;color:#C7CDD9;font:500 12px/1.4 Inter,-apple-system,Segoe UI,system-ui,sans-serif;box-shadow:0 8px 20px -8px rgba(11,15,26,.5);transform:translateY(4px) scale(.98);opacity:0;pointer-events:none;transition:transform .22s cubic-bezier(.2,.8,.2,1),opacity .18s ease;text-align:center}'
    + '.klaut-slime-say.is-open{transform:translateY(0) scale(1);opacity:1}'
